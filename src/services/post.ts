...
export const postService = {
  ...
  async getPublicPosts(limit = 20, offset = 0) {
    ...
    const verifiedByUserIds =
      (data as unknown as Array<{ User?: { verifiedBy?: string | null } }>)
    ...
    const transformedData = (data as unknown as Array<{ User?: { verifiedBy?: string | null }; [key: string]: unknown }>)?.map((post) => {
