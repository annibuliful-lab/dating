...
export const theme = createTheme({
  ...
  components: {
    Input: {
      styles: {
        input: {
          backgroundColor: "light-dark(var(--mantine-color-white), #111111)",
          color:
          ...
          boxShadow:
            "inset 0 0 0 1px light-dark(var(--mantine-color-gray-3), var(--mantine-color-dark-6)), 0 1px 0 0 rgba(255,255,255,0.04)",
          "::placeholder": {
            color:
          ...
          "&:focus": {
            ...
            boxShadow: `0 0 0 2px ${rgba("#FFD700", 0.15)}`,
          },
        },
      },
    },
    ...
    // Ensure labels across all input wrappers match the desired aesthetic
    InputWrapper: {
      styles: {
        label: {
          color:
    ...
    // Textarea uses its own component, mirror the same input surface
    Textarea: {
      styles: {
        input: {
          backgroundColor: "light-dark(var(--mantine-color-white), #111111)",
